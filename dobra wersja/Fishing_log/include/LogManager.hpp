...
public:
    ...
    ///Constructor. If it gets called load current data in json file to prevent clearing it and overwrite with current data
    void load(){
    ...
    ///Function to load data from .json file. Prevents data corruption 
    ...
    //Resets the input stream and ignores remaining characters in the current line
    ...
    /**
     * Template class to write what are we expecting from the user
     * Return correct type of data, prevents of errors
     */
    ...
    /**
     * Poor version of checkInput
     * Using for data validation in editing objects
     */
    ...
    void editLog(){
        ...
        if(m_jsonData["log"].contains(date)){
            ...
            switch(selectEdit){
                ...
                ///Log start hour, place and weather editor
                ...
                case 2:{
                    ...
                    while(true){
                        ...
                        ///Predator and coarse fish has own atributes to write
